...
public class TransLate
{
	...
	private final static String TURL = "https://translate.google.cn/translate_a/single?client=t&sl=%s&tl=%s&hl=zh-CN&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&dt=at&ie=UTF-8&oe=UTF-8&source=btn&srcrom=1&ssel=0&tsel=0&kc=0&tk=90007|490943&q=%s";
	private final static String TTSURL = "https://translate.google.cn/translate_tts?ie=UTF-8&q=%s&tl=%s&prev=input";
