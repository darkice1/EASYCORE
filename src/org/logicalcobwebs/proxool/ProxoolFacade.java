...
public class ProxoolFacade {
     ...
     * @see #registerConnectionPool(String, Properties)
     */
    ...
    /**
     * Removes all connection pools. Kills all the connections. Resets everything.
     * Like {@link #shutdown(String, int)} but passes the current thread name
     * and a delay of zero.
     */
    ...
    /**
     * Like {@link #removeConnectionPool(String, int)} but uses no delay. (Kills
     ...
     * @throws ProxoolException if we couldn't find the pool
     * @deprecated use {@link #getSnapshot(String, boolean) snapshot} instead.
     */
     ...
     * @throws ProxoolException if we couldn't find the pool
     * @deprecated use {@link #killAllConnections(String, String, boolean) alternative}
     ...
     * @param alias to identify the pool
     * @throws ProxoolException if we couldn't find the pool
     * @deprecated use {@link #killAllConnections(String, String) alternative}
     * to provide better auditing in log
     */
    ...
    /**
     * Calls {@link #getSnapshot(String, boolean) getSnapshot}
     * using false for the detail parameter.
     * @see #getSnapshot(String, boolean)
     */
