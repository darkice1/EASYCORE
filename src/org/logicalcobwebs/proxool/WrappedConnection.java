...
/**
 * Wraps up a {@link ProxyConnection}. It is proxied as a {@link Connection}
...
public class WrappedConnection implements MethodInterceptor {
    ...
    /**
     * Delegates to {@link #invoke(Object, Method, Object[]) invoke}
     * @see MethodInterceptor#intercept(Object, Method, Object[], org.logicalcobwebs.cglib.proxy.MethodProxy)
     */
