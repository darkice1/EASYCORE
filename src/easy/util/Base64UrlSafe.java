...
public class Base64UrlSafe
{
    ...
    public static byte[] decodeBase64(String basestr)
    {
    	...
    	byte[] base64Data = basestr.getBytes();
     ...
     */
    public String encode(byte[] pArray)
    {
    ...
    {
    	System.out.println(Base64UrlSafe.encodeBase64("abcd".getBytes()));
    	System.out.println(new String(Base64UrlSafe.decodeBase64("YWJjZA")));
